...
## Corpus Check
- 18 files · ~4,374,946 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 184 nodes · 199 edges · 26 communities (13 shown, 13 thin omitted)
...
- **Why does `cn()` connect `about/page.tsx` to `app/page.tsx`, `contact/page.tsx`, `solution/page.tsx`, `footer.tsx`?**
