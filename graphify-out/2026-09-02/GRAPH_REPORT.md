# Graph Report - web-falah  (2026-09-02)

## Corpus Check
- 17 files · ~4,362,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 175 nodes · 186 edges · 25 communities (12 shown, 13 thin omitted)
...
Cohesion: 0.11
Nodes (9): A, CERTS, EXPERTS, PARTNERS, PROBLEMS, SOLUTION_SMALL, STATS, FaqAccordion() (+1 more)

### Community 1 - "button.tsx"
Cohesion: 0.12
Nodes (14): metadata, oxanium, poppins, Button(), ButtonProps, buttonVariants, companyLinks, contactInfo (+6 more)
...
Cohesion: 0.10
Nodes (17): A, Certification(), EXPERTS, Glow(), Head(), ISO_CARDS, LEADERS, Leadership() (+9 more)
...
## Knowledge Gaps
- **99 isolated node(s):** `A`, `PARTNERS_ROW_1`, `PARTNERS_ROW_2`, `PROBLEM_CARDS`, `VM_CARDS` (+94 more)
...
- **Why does `cn()` connect `about/page.tsx` to `app/page.tsx`, `solution/page.tsx`, `button.tsx`?**
